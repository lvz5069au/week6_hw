...
urlpatterns = [
    ...
    url(r'^users/search/(?P<pIndex>[0-9]+)$', users.search, name="myadmin_users_search"),
    ...
    url(r'^users/resetupdate/(?P<uid>[0-9]+)$', users.resetupdate, name="myadmin_users_resetupdate"),
